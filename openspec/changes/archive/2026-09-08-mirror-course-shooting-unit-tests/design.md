...
仅 course、shooting：course 的 CourseRulesTest→business；shooting 的 SceneAnalysisServiceTest、ShootingPlanServiceTest→service。当前生产类型已归层，单一职责单元测试应镜像对应层；架构、目录迁移、跨层组合和 bootstrap 集成测试保留根测试包。
