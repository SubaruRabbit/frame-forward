...
仅 generation、evaluation。将 com.frameforward.ai.AiTaskRuntime 引用改为 service.AiTaskRuntime，嵌套 CreateRequest/Created/State/Status/Trace 对应改为 model.dto 的 AiTaskCreateRequest/AiTaskCreated/AiTaskState/AiTaskStatus/AiTaskTrace。保持调用方法、参数、字段、mock 行为和断言含义不变。
