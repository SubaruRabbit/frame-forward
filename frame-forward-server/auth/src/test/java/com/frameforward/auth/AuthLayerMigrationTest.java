...
class AuthLayerMigrationTest {
	...
	void persistenceAndApplicationLayersUseDedicatedPackages() throws Exception {
		...
		for (String relative : new String[] {
				"model/entity/AccountEntity.java", "mapper/AccountMapper.java", "repository/AuthRepository.java",
				"manager/AuthManager.java", "business/AuthBusiness.java", "service/AuthService.java",
				"model/dto/SessionTokens.java", "model/dto/AccountDeletionJob.java"
		}) {
			assertTrue(Files.isRegularFile(root.resolve(relative)), relative);
		}

		for (String relative : new String[] {
				"service/AuthService.java", "business/AuthBusiness.java", "manager/AuthManager.java"
		}) {
