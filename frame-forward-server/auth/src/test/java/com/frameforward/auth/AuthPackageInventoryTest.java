...
class AuthPackageInventoryTest {
	...
	void controllerRequestsAreSeparateDataTypes() throws Exception {
		...
		assertTrue(Arrays.stream(controller.getDeclaredClasses()).noneMatch(Class::isRecord));

		for (String name : new String[] {
				"RegisterRequest", "LoginRequest", "RefreshRequest", "ChangePasswordRequest", "AccountDeletionRequest"
		}) {
