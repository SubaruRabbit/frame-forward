...
class PhotoEvaluationExceptionHandler {
	...
	@ExceptionHandler({
			PhotoEvaluationInvalid.class, ShootingSessionInvalid.class, RetakeComparisonInvalid.class
	})
	...
	@ExceptionHandler({
			PhotoEvaluationNotFound.class, ShootingSessionNotFound.class, RetakeComparisonNotFound.class
	})
