...
class AccountDeletionArchitectureTest {
	...
	void everyUserOwnedTableDeclaresCascadeOrCleanup() throws Exception {
		...
		for (String table : new String[] {
				"ai_tasks", "scene_analyses", "shooting_plans", "photo_evaluations", "reference_images",
				"shooting_sessions", "retake_links", "portfolio_favorites", "portfolio_work_deletion_jobs", "media"
		}) {
		...
		for (String table : new String[] {
				"user_equipment", "lesson_progress", "lesson_assignment_feedback"
		}) {
